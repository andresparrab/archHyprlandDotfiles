...
# Install dependencies for lunarvim
#sudo pacman --noconfirm --needed -S python python-pip cmake unzip ninja tree-sitter curl neovim rustup flake8 fish fisher exa dotnet-sdk aspnet-runtime aspnet-runtime-6.0 fzf ghc stow sddm paru
...
#nvm install latest
#echo nvm use $(node --version) >> $HOME/.config/fish/config.fish
...
#yes | LANG=C yay --noprovides --answerdiff None --answerclean None --mflags "--noconfirm" -S nerd-fonts-cascadia-code vim-plug aspnet-runtime-5.0-bin wlogout
